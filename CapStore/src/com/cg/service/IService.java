...
//THE FUNCTION SHOULD INDICATE A VERB...AN ACTION BEING 
...
public interface IService{
	...
	boolean changePassword(String user_id, String old_password, 
	String new_password);
	...
	Collection<Product> searchByCategory(String 

categorysearchkey);
	Collection<Product> searchByBrand(List<String> 

brandsearchkey);
	Collection<Product> searchByPrice(float minprice, float 
...
maxprice);
	...
	boolean createCoupon(String merchant_id, String scheme_id, 

String scheme_name, String value, String type);
	boolean addCoupon(String merchant_id, String product_id, String 

scheme_id, Date start_date, Date end_date);
	boolean removeCoupon(String product_id, String merchant_id, 
...
String scheme_id);
	...
	boolean setPromoMail(Date start_date, Date end_date, int 

frequency, Date starttime, Date endtime, int timefrequency);
